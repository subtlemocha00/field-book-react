...
import { handleListPendingMutations } from './routes/mutations';

const PHASE = 4;
const SERVICE_NAME = 'field-book-api';
const SERVICE_VERSION = '0.0.0';
const BUILD_ID = 'phase-4-dev';
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (method === 'GET' && url.pathname === '/mutations') {
      return handleListPendingMutations(env, clock);
    }
