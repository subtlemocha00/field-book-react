...
export async function handleCreateNote(
  ...
  try {
    ...
    await recordMutation(env.DB, ids, clock, 'note', note.id, 'create', note);
    return ok(note, 201);
  } catch (err) {
...
export async function handleUpdateNote(
  ...
  try {
    ...
    await recordMutation(env.DB, ids, clock, 'note', note.id, 'update', note);
    return ok(note);
  } catch (err) {
    return mapPersistenceError(err);
  }
...
export async function handleDeleteNote(
  ...
  try {
    ...
    await recordMutation(env.DB, ids, clock, 'note', note.id, 'delete', note);
    return ok(note);
  } catch (err) {
    return mapPersistenceError(err);
  }
